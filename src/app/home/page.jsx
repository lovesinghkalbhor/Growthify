...
export default function Home() {
  ...
  return (
    <>
      <div className=" hero__container overflow-x-hidden relative sm:mb-40 xs:mb-20">
        <Image
      ...
      <div className=" 2xl:container relative 2xl:mx-auto ">
        <section className="our__services pb-20 sm:mb-60 mb-20">
            ...
            <div>
              <div className="section__heading w-full justify-start py-28 sm:px-10 px-6">
                <motion.h1
                  ...
                  transition={{ staggerChildren: 0.1 }}
                >
                  {stringToCharArray(our_services_heading).map((char) => (
                    <motion.span
                      key={char}
                      variants={text_reveal}
                      transition={{ duration: 0.2 }}
              ...
              <motion.div
                ...
                viewport={{ amount: 0.4 }}
                className="our__services-cards-container  sm:px-10 px-6"
              >
      ...
      >
        ...
        <motion.div
          ...
          animate={{
            ...
            // Pause at current position
            transition: { duration: 10, repeat: Infinity, ease: "linear" }, // Customize as needed
          }}
        >
      ...
      <div className=" bg-stone-950">
        <section className="our__clients xl:container mx-auto">
          ...
          <motion.div
            ...
            variants={card_animation_parent}
            viewport={{ amount: 0.2 }}
            className="relative  grid sm:grid-cols-2 gap-5 p-20 px-10 pt-5 lg:w-3/5 md:w-4/5 justify-items-end"
          >
            <Image
