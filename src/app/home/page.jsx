...
export default function Home() {
  return (
    <>
      <div className=" hero__container overflow-x-hidden relative">
        <Image
        ...
        <header className="grid lg:grid-cols-5 md:grid-cols-6 xl:container mx-auto">
          <div className="lg:col-span-3 md:col-span-4  sm:my-44 my-28 md:mx-16  sm:mx-10  mx-6 ">
            ...
            <div className="hero__text__container col-span-6 row-start-1 col-start-2 sm:mt-0 mt-40">
              <h1 className="xl:text-[3.3rem] lg:text-[3rem] md:text-4xl sm:text-4xl xs:3xl text-2xl  lg:leading-tight  font-bold">
                WE ARE GROWTHIFY SERVICES ONLINE BUSINESS SOLUTION
              </h1>
              <p className="lg:text-xl md:text-lg sm:text-base text-sm mt-4 pr-12">
                We help your business to grow online with minimal efforts and
                helops you to grow your business{" "}
              </p>
            </div>
        ...
        <div className="about__us xl:container  xl:mx-auto flex lg:flex-row-reverse   pb-60">
          ...
          <div className="lg:w-1/2 z-50   mb-32">
            ...
            <div className="about__us-text-container">
              ...
              <button className="orange__button-large mr-12 text-white">
                Contact Us
              </button>
            </div>
      ...
      <section className="portfolio mt-20 container mx-auto mb-28">
        <div className="grid md:grid-cols-3 xs:grid-cols-2 gap-5 xs:p-0 p-10">
