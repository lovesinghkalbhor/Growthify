        ...
        <div className="px-10 w-full  text-white flex flex-col">
          ...
          <div className="flex flex-col">
            <div className="flex mt-24 mb-12 flex-row justify-between">
              ...
              <div className="flex flex-row space-x-8 items-center justify-between">
                ...
                >
                  ...
                  >
                    <path
                      d="M2.53907 12H0.187731V3.86466H2.53907V12ZM1.36083 2.81559C0.609151 2.81559 0 2.19758 0 1.43305C0 0.668526 0.609151 0.0505121 1.36083 0.0505121C2.11249 0.0505121 2.72164 0.668526 2.72164 1.43305C2.72164 2.19758 2.11249 2.81559 1.36083 2.81559ZM11.9626 12H9.60964V8.28303C9.60964 7.20671 9.58797 5.8184 8.25077 5.8184C6.89118 5.8184 6.675 7.01198 6.675 8.20994V12H4.32192V3.86466H6.5628V4.95686H6.59309C6.9216 4.32291 7.68951 3.64425 8.84313 3.64425C11.2464 3.64425 11.9631 5.27314 11.9631 7.6887V12H11.9626Z"
                      fill="white"
                    />
                  </svg>
                </a>
            ...
            <p className="w-full text-center my-12 text-gray-600">
              Copyright © 2020 Growthify services
            </p>
          </div>
        </div>
      </div>
